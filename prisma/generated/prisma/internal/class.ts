...
const config: runtime.GetPrismaClientConfig = {
  ...
  "inlineSchemaHash": "2e63b0ae69df8fe2f7b48ba16aab760b78d0db853d34045fa69ebd9a1764b0d8",
  "copyEngine": true,
  "runtimeDataModel": {
    "models": {},
    "enums": {},
...
/**
  ...
  /**
   * `prisma.doctorVerification`: Exposes CRUD operations for the **DoctorVerification** model.
    * Example usage:
    * ```ts
    * // Fetch zero or more DoctorVerifications
    * const doctorVerifications = await prisma.doctorVerification.findMany()
    * ```
    */
  get doctorVerification(): Prisma.DoctorVerificationDelegate<ExtArgs, { omit: OmitOpts }>;
